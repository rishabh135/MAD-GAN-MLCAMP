...
parser.add_argument('--ngen', type = int, default = 6, help = 'number of generators')
parser.add_argument('--ndata', type = int, default = 10000, help = 'number of data per epoch')
...
for epoch in tqdm(range(opt.niter)):
	...
	if (epoch%save_freq == 0):
		...
		plt.savefig(opt.exp_name + str(epoch) + '_input.png')
		plt.close()
		...
		plt.savefig(opt.exp_name + str(epoch) + '_output.png')
